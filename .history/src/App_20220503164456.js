      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          <s.Container flex={1} jc={'center'} ai={'center'}>
            ...
            <s.TextTitle
                  style={{ textAlign: 'center', color: 'var(--accent-text)', fontSize: '1.2rem' }}
                >
                  Delve into the Stronghold's depths and start earning <a>$XRLC</a> now!
                </s.TextTitle>
            ...
            {parseInt(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              <>
                <s.TextTitle
