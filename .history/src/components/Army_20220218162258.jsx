                    ...
                    > */}
                        ...
                        {blockchain.account === '' ||
                            ...
                            <s.SpacerSmall />
                                ...
                                <s.Container style={{display: 'flex', flexDirection: 'row', flexWrap: 'wrap', width: '100%'}}>
                                <s.Container style={{ display: 'flex', flexDirection: 'row', width: '33.33%' }}>

                                
                                    {lords.map((item,index)=>{
                                        return <Card key={index} style={{ display: 'flex', flexDirection: 'column', width: '100%'}}>
