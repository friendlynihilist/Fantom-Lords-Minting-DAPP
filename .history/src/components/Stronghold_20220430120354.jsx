    ...
    try {
      await Promise.all(
        idsArray.map(async (_pid) => {
          ...
          if (_pid == 0) {
            poolImageUri = '../../public/config/images/1.gif';
          } else if (_pid == 1) {
            poolImageUri = '../../public/config/images/enricreepto.png';
          } else if (_pid == 2) {
            ...
            poolImageUri = jsonifyRespFT.image.replace(
              URIprefix,
              'https://cloudflare-ipfs.com/ipfs/'
            );
          }
                              ...
                              >
                                ...
                                >
                                  <small className="text-muted">
                                    ...
                                    network and/or <a style={{fontWeight: 'bold', color: 'var(--secondary)', cursor: 'pointer'}} onClick={() => window.location.reload(false)}>refresh</a>. If the problem
