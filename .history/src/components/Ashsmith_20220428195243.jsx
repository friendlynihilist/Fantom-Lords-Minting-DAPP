                  ...
                  >
                    <TypeWriterEffect
                      ...
                      multiText={[
                        ...
                        'Are you willing to burn some of your Relics as a pious offering?',
                      ]}
                      typeSpeed={45}
                      // scrollArea={myAppRef}
                    />
                  </s.TextDescription>
              <s.Container ai={'center'} jc={'center'} style={{border: '1px solid var(--secondary)', borderRadius: '10px', padding: '30px', width: 'auto'}}>
                ...
                >
                  You're forging {mintAmount} Artifact(s) for {mintAmount * 122} XRLC (+
                  gas fees).
                </s.TextDescription>
                <s.SpacerSmall />
                ...
                {!lords ? (
                  <>
                    ...
                    <s.SpacerSmall />
                    <s.Container ai={'center'} jc={'center'} fd={'row'}
                    style={{border: '1px solid var(--secondary)', borderRadius: '10px', padding: '30px', width: 'auto'}}
                    >
                      {!isChecking && (
                        <StyledButton
