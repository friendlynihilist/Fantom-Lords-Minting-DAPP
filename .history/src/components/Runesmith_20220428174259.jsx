      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          <s.Container flex={1} jc={'center'} ai={'center'}>
            ...
            <s.Container flex={1} jc={'center'} ai={'center'} style={{border: '1px solid var(--secondary)', maxWidth: '520px', padding: '10px'}}>
            ...
            <TypeWriterEffect
                    ...
                    multiText={[
                      ...
                      'May I have a closer look to those shiny trinkets in your backpack?',
