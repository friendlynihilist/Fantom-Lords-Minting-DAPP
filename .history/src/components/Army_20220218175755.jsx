                            ...
                            <s.SpacerSmall />
                                ...
                                <s.Container fd={'row'} style={{ display: 'flex', flexWrap: 'wrap', width: '70%' }}>
                                    ...
                                    {lords.map((item,index)=>{
                                        return <Card key={index} fd={'column'} class='responsive-card' style={{ flex: '0 0 31%', marginLeft: '10px', marginRight: '10px', marginBottom: '20px', backgroundColor: '#00000061', fontFamily: 'Courier New, monospace'}}>
