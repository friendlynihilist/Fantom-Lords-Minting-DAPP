                    ...
                    {!poolsInfo ? (
                      ...
                      <>
                        ...
                        <s.Container ai={'center'}
                          ...
                          <s.TextDescription>
                          {(poolsInfo.map((pool, idx) => parseInt(pool.stakedNfts.balance) + parseInt(pool.ownedNfts.balance))) < 5 ? "CIAO" + idx : "BUUH"+ idx}
                          </s.TextDescription>
                        <Row xs={1}
                        md={2}
                        lg={(poolsInfo.map((pool) => parseInt(pool.stakedNfts.balance) + parseInt(pool.ownedNfts.balance))) < 5 ? 1 : 5}
                        className="g-4"
                        >
                          {poolsInfo.map((pool, idx) =>
