...
function Army() {
    ...
    const getConfig = async () => {
        const configResponse = await fetch('/config/test_config.json', {
            headers: {
    ...
    async function listTokensOfOwner(address) {
        const balance = await blockchain.smartContract.methods.loot().call();
                                    ...
                                    Lorem Ipsum
                                        ...
                                        <s.Container fd={'row'} style={{ display: 'flex', flexWrap: 'wrap', width: '80%' }}>
                                            ...
                                            {lords.map((item, index) => {
                                                return <Card key={index} fd={'column'} style={respCard}>
