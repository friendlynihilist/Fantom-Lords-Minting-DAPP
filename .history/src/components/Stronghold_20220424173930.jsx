                    ...
                    {!poolsInfo ? (
                      ...
                      <>
                        ...
                        <s.Container flex={1} jc={'center'} ai={'center'}>
                          ...
                          <s.SpacerLarge />
                          <s.SpacerLarge />
                          <s.Container flex={1} jc={'center'} ai={'center'} style={{borderBottom: '1px solid var(--accent-text)'}}>
                            <s.TextDescription
                              style={{
                                textAlign: 'center',
                                color: 'var(--accent-text)',
                            ...
                            >
                              Send your adventurers through the depths of this ancient bastion 
                              to loot precious Arcane Relics ($XRLC).
                            ...
                            >
                                    <small className="text-muted">
                                            Stronghold is currently in beta and may have minor bugs.
                                          </small>
                            </s.TextDescription>
                          <s.SpacerLarge />
                          <s.SpacerLarge />
