      ...
      await Promise.all(
        idsArray.map(async (_pid) => {
          ...
          const responseFT = await fetch(
            firstTokenUri.replace('ipfs://', 'https://cloudflare-ipfs.com/ipfs/')
          );
                              ...
                              >
                                ...
                                >
                                  <small className="text-muted">
                                    If the page does not load, please change network and refresh. If the problem persists, try clearing your browser cache.
                                  </small>
                                </s.TextDescription>
                                <s.SpacerLarge />
                                <s.SpacerLarge />
