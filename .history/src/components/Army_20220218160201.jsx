                            ...
                            <>
                                ...
                                >
                                    Lorem Ipsum
                                        ...
                                        <s.Container ai={'center'} jc={'center'} fd={'row'} style={{ display: 'flex', flexDirection: 'row', width: '33.33%' }}>


                                            {lords.map((item, index) => {
                                                return <Card key={index} fd={'column'} style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
