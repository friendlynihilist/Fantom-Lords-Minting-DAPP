...
function Runesmith() {
  ...
  const claimNFTs = async () => {
    ...
    const artifactContract = new web3.eth.Contract(artifactsAbi, artifactAddress);
    //
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          <s.Container flex={1} jc={'center'} ai={'center'}>
            <StyledImg
                            alt={'The Runesmith'}
                            src={'/config/images/runesmith.webp'}
                            style={{ imageRendering: 'pixelated', width: '70%' }}
                        />
                    ...
                    {!lords.length ? (
                      ...
                      <s.SpacerSmall />
                          ...
                          >
                            ...
                            <br/>
                            The Runesmith may help you, if you're willing to offer something in turn...
                          </s.TextDescription>
                    </s.Container>
                    ) : (
                      <Row
