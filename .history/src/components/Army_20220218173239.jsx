                    ...
                    >
                        ...
                        {blockchain.account === '' ||
                            ...
                            <s.SpacerSmall />
                                ...
                                <s.Container fd={'row'} style={{ display: 'flex', flexWrap: 'wrap', width: '70%' }}>

                                
                                    {lords.map((item,index)=>{
                                        return <Card key={index} fd={'column'} style={{ flex: '0 0 31%', marginLeft: '10px', marginRight: '10px', marginBottom: '20px', backgroundColor: '#00000061', color: 'white', fontFamily: 'Courier New, monospace'}}>
                                        <Card.Img variant="top" src={(item.image).replace('ipfs://', 'https://ipfs.io/ipfs/')} />
                                        <Card.Body>
                                          <Card.Title>{item.name}</Card.Title>
                                          <Card.Text>
                                            <ul>
                                                <li>{`<b>${item.attributes[0].trait_type}</b>: ${item.attributes[0].value}`}</li>
