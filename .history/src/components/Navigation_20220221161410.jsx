...
function Navigation() {
    return (
        <div className="navigation" style={{ position: 'absolute' }}>
            <nav className="navbar navbar-expand navbar-dark"  style={{ padding: 34, backgroundColor: 'var(--primary-dark)', position: 'sticky' }}>
