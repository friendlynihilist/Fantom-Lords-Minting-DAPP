...
function Footer() {
    return (
        // per aggiungere fixed-bottom basta aggiungere class="fixed-bottom" al footer
        <footer> 
            <s.Container flex={1}
            ai={'center'}
            style={{ padding: 24, backgroundColor: 'var(--primary)' }}>
                        <ResponsiveWrapper flex={1} style={{ padding: 40, width: '28%' }}z>
                            <s.Container
                                ...
                                jc={'center'}
                                ai={'end'}
                                style={{ paddingBottom: 10, paddingRight: '15px' }}
                            >
                                <a
                            ...
                            <s.Container
                                ...
                                jc={'center'}
                                ai={'start'}
                                style={{ paddingBottom: 10, paddingLeft: '15px' }}
                            >
                                <a
