    ...
    try {
      await Promise.all(
        idsArray.map(async (_pid) => {
          ...
          const XRLCrespone = await fetch('/config/abi_xrlc.json', {
            headers: {
              'Content-Type': 'application/json',
              Accept: 'application/json',
            },
          });
          const XRLCAbi = await XRLCrespone.json();
          const XRLCAddress =
                    ...
                    {!poolsInfo ? (
                      ...
                      <>
                        ...
                        >
                          ...
                          >
                            You own a total of {(ownedXRLC / 1e18).toFixed(3)}{' '}<a href="https://ftmscan.com/token/0xE5586582E1a60E302a53e73E4FaDccAF868b459a" target="_blank">$XRLC</a>.
                          </s.TextDescription>
                          {/* <s.TextDescription
                            style={{
                              textAlign: 'center',
                          ...
                          >
                            There are {(harvestXRLC / 1e18).toFixed(3)}{' '}$XRLC to be harvested.
                          </s.TextDescription> */}
                          <s.TextDescription
                            style={{
                              textAlign: 'center',
                          ...
                          >
                            You can exchange $XRLC on <a href="https://spookyswap.finance/swap?outputCurrency=0xe5586582e1a60e302a53e73e4fadccaf868b459a" target="_blank">SpookySwap</a>. 
                          </s.TextDescription>
                        </s.Container>
                        <Nav
                          ...
                          {poolsInfo.map((pool, idx) =>
                            pool.stakedNfts.info.map((id) => (
                              ...
                              >
                                ...
                                >
                                  {
                                    pool.poolId == 0 && (id.tokenId == 1 || id.tokenId == 2 || id.tokenId == 3) ? (
                                      <Card.Img
