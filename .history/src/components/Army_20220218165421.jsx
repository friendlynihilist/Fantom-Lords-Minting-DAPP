                    ...
                    >
                        ...
                        {blockchain.account === '' ||
                            ...
                            <s.SpacerSmall />
                                ...
                                <s.Container ai={'center'} jc={'center'} style={{ border: '2px dotted rgb(96, 139, 168)', width: '70%' }}>
                                <s.Container fd={'row'} style={{ display: 'flex', flexWrap: 'wrap', margin: '-10px' }}>

                                
                                    {lords.map((item,index)=>{
                                        return <Card key={index} fd={'column'} style={{ flex: '0 0 33.3333%', margin: '10px' }}>
