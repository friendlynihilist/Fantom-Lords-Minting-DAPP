    ...
    return(        
        <s.Screen>
            ...
            >
                <> 
                    <>
                        <ResponsiveWrapper flex={1} style={{ padding: 24, display: "flex" }}>
                            <s.Container flex={1} jc={'top'} ai={'center'}>
                                <s.SpacerLarge />
                                <HeaderTitle>
                                    Fantom Lords: Relic Survival  
                                </HeaderTitle>
                                <s.SpacerLarge />
                                <s.TextDescription style={{ textAlign: 'center', color: 'white', width: 'auto', }}>
                                        <a target='_blank' href={"https://devpost.com/software/fantom-lords-relic-survival"}>Devpost</a> Hackathon preview build, read the instructions below.
                                </s.TextDescription>
                                <s.SpacerLarge />
                                <iframe 
                                    src="https://stomaco.studio/FantomLords_Game/RelicSurvival.html"
                                    width="1366"
                                    height="768"
                                    ></iframe> 
                                <s.SpacerLarge />
                                ...
                                <s.TextDescription>
                                    ...
                                    - A working Metamask set up on the correct <a target='_blank' href={"https://docs.fantom.foundation/wallet/set-up-metamask"}>Fantom RPC</a>. <br/>
                                    - Signing the first transaction is necessary to identify you and start the game. <br/>
                                    - You do not need to approve the second transaction if you're not interested in receiving XRLC rewards or if you're just trying out the game, it will start even if you refuse. <br/>
                                    - Hard refreshing the page can solve most problems(CTRL-SHIFT-R, CTRL-F5) if the game does not load properly. <br/>
                                    - Chrome or a Chrome-based browser are strongly suggested. <br/>
                                    - Move with WASD or with the control ARROW KEYS, use your powerup attacks with SPACEBAR or J. <br/>
                                    <br/>
                                    Collect as many coins as you can to increase your high score is calculated at the end of the run based on: <br/>
                                    - Your interaction with the contract. <br/>
                                    - The number of <a target='_blank' href={"https://paintswap.finance/marketplace/fantom/collections/fantom-lords"}>Fantom Lords NFTs</a> that you own. <br/>
                                    - The number of <a target='_blank' href={"https://paintswap.finance/marketplace/fantom/collections/ascended-fantom-lords"}>Ascended Fantom Lords NFTs</a> that you own. <br/>
                                </s.TextDescription>
                                <s.SpacerLarge />
                            </s.Container>
                            <s.SpacerLarge />
